...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: "Get the authenticated user's watchlist" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "Successfully fetched watchlist" }),
...
__decorate([
    (0, common_1.Post)("add"),
    (0, swagger_1.ApiOperation)({ summary: "Add card to the authenticated user's watchlist" }),
    (0, swagger_1.ApiResponse)({ status: 201, description: "Card successfully added" }),
    __param(0, (0, get_user_decorator_1.GetUser)("id")),
    __param(1, (0, common_1.Body)("cardId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], WatchlistController.prototype, "addCard", null);
__decorate([
    (0, common_1.Delete)("remove/:cardId"),
    (0, swagger_1.ApiOperation)({ summary: "Remove card from the authenticated user's watchlist" }),
    (0, swagger_1.ApiResponse)({ status: 200, description: "Card successfully removed" }),
    __param(0, (0, get_user_decorator_1.GetUser)("id")),
    __param(1, (0, common_1.Param)("cardId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], WatchlistController.prototype, "removeCard", null);

    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        <div className="glass-elevated rounded-2xl p-8 sm:p-10">
          ...
          <Button variant="outline" className="w-full h-11 rounded-xl font-medium text-sm mb-4">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button className="w-full h-11 rounded-xl gradient-bg text-white border-0 font-medium group" type="submit">
